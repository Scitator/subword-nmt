...
def encode(orig, bpe_codes, bpe_codes_reverse, vocab, separator, version, glossaries=None,
           cache={}):
...
def isolate_glossary(word, glossary):
    ...
    if word == glossary or glossary not in word:
        ...
        segments = [segment.strip() for split in splits[:-1] for segment in [split, glossary] if
                    segment != '']
